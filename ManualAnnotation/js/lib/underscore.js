...
(function(){
    function r(a,c,d){
        ...
        for(var f=d.length;f--;)if(d[f]==a)return!0;d.push(a);
        var f=0,g=!0;
        if("[object Array]"==e){
            ...
            for(var h in a)if(b.has(a,h)&&(f++,!(g=b.has(c,h)&&r(a[h],c[h],d))))break;if(g){
...
b.indexOf=function(a,c,d){
    ...
    d=0;
    for(e=a.length;d<e;d++)if(d in a&&a[d]===c)return d;return-1
    };
    
b.lastIndexOf=function(a,b){
    if(a==null)return-1;
    if(F&&a.lastIndexOf===F)return a.lastIndexOf(b);
    for(var d=a.length;d--;)if(d in a&&a[d]===b)return d;return-1
    };
...
b.keys=L||function(a){
    ...
    var c=[],d;
    for(d in a)b.has(a,d)&&(c[c.length]=d);return c
    };
...
function(a){
    ...
    for(var c in a)if(b.has(a,c))return false;return true
    };
